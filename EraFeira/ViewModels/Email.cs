...
using System.Linq;
using System.Net.Mail; // biblioteca importada
using System.Web;
    ...
    public class Email
    {
        public static string EnviarEmail(string emailDestinatario, string assunto, string corpomsg)
        {
            try
            {
                ...
                MailAddress de = new MailAddress("EraFeira <contatoerafeira@gmail.com>");
                ...
                //Prioridade E-mail
                mensagem.Priority = MailPriority.Normal; // caso queira mudar a prioridade do email (urgente, normal...)
